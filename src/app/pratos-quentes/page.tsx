    ...
    <main>
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <ItemMenu title="Medalhão de Mignon com risoto cremoso" photoUrl="/risoto-ia.webp" />
          <ItemMenu title="Fettuccine na manteiga e ervas com frango ou mignon" photoUrl="/fetutine-mignon.webp" />
